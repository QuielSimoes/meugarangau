...
define('CADASTRO_META', 16);
define('EDICAO_META', 17);
define('CADASTRO_TAREFA', 18);
define('EDICAO_TAREFA', 19);
define('EXCLUSAO_TAREFA', 20);

define('GOOGLE_APPLICATION_NAME', 'Cliente Web 1');
define('GOOGLE_CREDENTIALS_PATH', "credentials.json");
define('GOOGLE_CLIENT_SECRET_PATH', "client_secret.json");
define('GOOGLE_SCHEDULE_SCOPES', implode(' ', array(
